...
train_encoded = 'models/Boat_train_encoded.npy'
...
# %%
epoch=50 # it runs for 50 epochs
...
if anomaly_detection_task:
    ...
    x_latent_train,x_latent_test,true_labels, pred_labels_dict, ad_metrics_dict = anomaly_detection(\
        encoder, train_data, train_labels, val_test_data, val_test_labels, dataset_name="Boat")
...
weights_path = f'{output_dir}/Boat_CausalCNN_encoder'
