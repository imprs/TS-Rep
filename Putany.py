...
parser.add_argument('--cnn_output_size', default=80, type=int,
                    help='output size of causal dilated cnn \
...
reduced_size = args.cnn_output_size
...
train_encoded = 'models/Putany_train_encoded.npy'
...
if anomaly_detection_task:
    ...
    x_latent_train,x_latent_test,true_labels, pred_labels_dict, ad_metrics_dict = anomaly_detection(\
        encoder, train_data, train_labels, val_test_data, val_test_labels, dataset_name="Putany")
...
# %%
# log model state
weights_path = f'{output_dir}/Putany_CausalCNN_encoder'
